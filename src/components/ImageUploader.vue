<template>
  <div class="image-uploader">
    ...
    <Upload v-show="uploadList.length<limit" ref="upload" :show-upload-list="false" :headers ="headers" :default-file-list="defaultList" :on-success="handleSuccess" :format="['jpg','jpeg','png']" :max-size="2048" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :before-upload="handleBeforeUpload" multiple type="drag" :action="file" class="uploader">
